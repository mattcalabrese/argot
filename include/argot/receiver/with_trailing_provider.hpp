...
#ifndef ARGOT_RECEIVER_WITH_TRAILING_PROVIDER_HPP_
#define ARGOT_RECEIVER_WITH_TRAILING_PROVIDER_HPP_
...
struct with_trailing_provider_t
{
...
} inline constexpr with_trailing_provider{};

template< class Receiver, class Provider >
using result_of_with_trailing_provider_t
  = basic_result_of_t< with_trailing_provider_t const&, Receiver, Provider >;
...
< ArgumentReceiver
  < receiver::with_trailing_provider_t::impl< Receiver, Provider > >
>
{
  template
  ...
  receive_branch
  ( receiver::with_trailing_provider_t::impl< Receiver, Provider >&& self
  , LeadingArgs, TrailingArgs, P&&... args
  )
  {
    return prov_traits::provide
    ( ARGOT_MOVE( self.provider )
    , receiver::with_leading_arguments
