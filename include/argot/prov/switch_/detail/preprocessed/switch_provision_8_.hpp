...
struct switch_provision< 5, Kind >
  : switch_provision_base< Kind >
{
  ...
  )
  {
    ...
    std::size_t constexpr index_offset
      = switch_traits::num_cases_v< body_t > - 5;
    if constexpr
...
template< provision_kind Kind >
struct switch_provision< 6, Kind >
  : switch_provision_base< Kind >
{
  using base_t = switch_provision_base< Kind >;
  template< class T >
  ...
  )
  {
    ...
    using qualified_body_t = with_qualifiers_t< body_t >;
    std::size_t constexpr index_offset
      = switch_traits::num_cases_v< body_t > - 6;
    if constexpr
    ( is_modeled_v< SwitchBodyDefault< body_t > > || index_offset != 0 )
      switch( self.value )
      {
...
template< provision_kind Kind >
struct switch_provision< 7, Kind >
  : switch_provision_base< Kind >
{
  using base_t = switch_provision_base< Kind >;
  template< class T >
  ...
  )
  {
    ...
    using qualified_body_t = with_qualifiers_t< body_t >;
    std::size_t constexpr index_offset
      = switch_traits::num_cases_v< body_t > - 7;
    if constexpr
    ( is_modeled_v< SwitchBodyDefault< body_t > > || index_offset != 0 )
      switch( self.value )
      {
...
template< provision_kind Kind >
struct switch_provision< 8, Kind >
  : switch_provision_base< Kind >
{
  using base_t = switch_provision_base< Kind >;
  template< class T >
  ...
  )
  {
    ...
    using qualified_body_t = with_qualifiers_t< body_t >;
    std::size_t constexpr index_offset
      = switch_traits::num_cases_v< body_t > - 8;
    if constexpr
    ( is_modeled_v< SwitchBodyDefault< body_t > > || index_offset != 0 )
      switch( self.value )
      {
