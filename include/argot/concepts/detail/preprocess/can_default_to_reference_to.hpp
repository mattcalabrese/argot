...
Or < And < ArgumentProvider< detail_argot::remove_cvref_t< P > > , Sinkable< P > > , Not< ArgumentProvider< detail_argot::remove_cvref_t< P > > > > >::type; struct assertion : requirements::assertion {}; };
