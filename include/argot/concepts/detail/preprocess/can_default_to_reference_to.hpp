...
==============================================================================*/
# line 40 "../../concepts/can_default_to_reference_to.hpp"
template< class P >
...
Or < Not< ArgumentProvider< detail_argot::remove_cvref_t< P > > > , Sinkable< P > > >::type; struct assertion : requirements::assertion {}; };
