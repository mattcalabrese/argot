...
#ifndef ARGOT_CONCEPTS_INTRINSIC_THENABLE_HPP_
#define ARGOT_CONCEPTS_INTRINSIC_THENABLE_HPP_
...
ARGOT_EXPLICIT_CONCEPT( IntrinsicThenable )
(
  Future< Fut >
...
#endif  // ARGOT_CONCEPTS_INTRINSIC_THENABLE_HPP_
