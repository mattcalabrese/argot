...
s/higher_order_argument_provider.h
...
template< class Provider >
ARGOT_EXPLICIT_CONCEPT( HigherOrderArgumentProvider )
(/*
  ArgumentProvider< Provider >
, TransparentRequirement
  < higher_order_argument_provider_detail::all_provisions_are_providers >*/
);
...
< HigherOrderArgumentProvider< Provider >
, call_detail::fast_enable_if_t
  < higher_order_argument_provider_detail
    ::is_higher_order_argument_provider_v< Provider >
  >
> {};
