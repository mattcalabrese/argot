...
#ifndef ARGOT_CONCEPTS_THENABLE_HPP_
#define ARGOT_CONCEPTS_THENABLE_HPP_
...
ARGOT_EXPLICIT_CONCEPT( Thenable )
(
  Future< Fut >
...
, ARGOT_REQUIRES
  ...
  ( Not< IntrinsicThenable< Fut, FutPackager, Exec > > )
  <>
>
{
...
< Thenable< Fut, FutPackager, Exec >
, ARGOT_REQUIRES
  ( IntrinsicThenable< Fut, FutPackager, Exec > )<>
>
{
...
#endif  // ARGOT_CONCEPTS_THENABLE_HPP_
