...
#ifndef ARGOT_CONCEPTS_SWITCH_BODY_FOR_TYPE_HPP_
#define ARGOT_CONCEPTS_SWITCH_BODY_FOR_TYPE_HPP_
...
namespace argot {
namespace switch_body_for_type_detail {
...
< ValueType, Body, value_list_t< Values... > >
{
  ...
  using expand_requirements
    = Reqs< SwitchBodyCase< Body, static_cast< ValueType >( Values ) >... >;
};
...
struct switch_body_for_type_default_requirements_impl
{
  template< template< class... > class Reqs >
  using expand_requirements
    = Reqs< SwitchBodyDefaultForType< Body, ValueType > >;
};
...
} // namespace argot(::switch_body_for_type_detail)

#define ARGOT_DETAIL_PREPROCESSED_CONCEPT_HEADER_NAME()                        \
s/switch_body_for_type.h
...
template< class Body, class ValueType >
ARGOT_AUTO_CONCEPT( SwitchBodyForType )
(
  SwitchBody< Body >
, SwitchCondition< ValueType >  // TODO(mattcalabrese) Make that conversion to type has no duplicates
, TransparentRequirement
  < switch_body_for_type_detail::switch_body_for_type_case_requirements
    < Body, ValueType >
  >
, TransparentRequirement
  < switch_body_for_type_detail::switch_body_for_type_default_requirements
    < Body, ValueType >
  >
);
...
#endif  // ARGOT_CONCEPTS_SWITCH_BODY_FOR_TYPE_HPP_
