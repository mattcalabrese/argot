...
#ifndef ARGOT_CONCEPTS_ARGOT_INVOCABLE_WITH_PERSISTENT_REDUCTION_HPP_
#define ARGOT_CONCEPTS_ARGOT_INVOCABLE_WITH_PERSISTENT_REDUCTION_HPP_
...
namespace argument_invocable_with_persistent_reduction_detail {
...
struct argument_invocable_with_persistent_reduction_impl {};
...
struct argument_invocable_with_persistent_reduction
  : argument_invocable_with_persistent_reduction_impl
    < Reducer, Invocable
    , prov_traits::argument_list_kinds_of_destructive_t
      < prov::result_of_default_to_reference_to_t< P... > >
    > {};

} // namespace argot(::argument_invocable_with_persistent_reduction_detail)

#define ARGOT_DETAIL_PREPROCESSED_CONCEPT_HEADER_NAME()                        \
s/argot_invocable_with_persistent_reduction.h
...
template< class Reducer, class Invocable, class... P >
ARGOT_AUTO_CONCEPT( ArgotInvocableWithPersistentReduction )
(
  ArgotInvocableWithReduction< Reducer, Invocable, P... >
, TransparentRequirement
  < argument_invocable_with_persistent_reduction_detail
    ::argument_invocable_with_persistent_reduction< Reducer, Invocable, P... >
  >
);
...
#endif  // ARGOT_CONCEPTS_ARGOT_INVOCABLE_WITH_PERSISTENT_REDUCTION_HPP_
