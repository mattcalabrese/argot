...
#ifndef ARGOT_CONCEPTS_RETURN_VALUE_REDUCER_OF_HPP_
#define ARGOT_CONCEPTS_RETURN_VALUE_REDUCER_OF_HPP_
...
namespace argot {
namespace return_value_reducer_of_detail {
...
using result_of_raw_reduce_t
  = decltype
    ( access_raw_concept_map< ReturnValueReducer< Reducer > >::reduce
      ( ARGOT_DECLVAL( Reducer&& )
...
} // namespace argot(::return_value_reducer_of_detail)

#define ARGOT_DETAIL_PREPROCESSED_CONCEPT_HEADER_NAME()                        \
s/return_value_reducer_of.h
...
template< class Reducer, class HeadReturnType, class... TailReturnTypes >
ARGOT_AUTO_CONCEPT( ReturnValueReducerOf )
( ReturnValueReducer< Reducer >
, ReturnType< HeadReturnType >
, ReturnType< TailReturnTypes >...
, Valid
  < return_value_reducer_of_detail::result_of_raw_reduce_t
...
#endif  // ARGOT_CONCEPTS_RETURN_VALUE_REDUCER_OF_HPP_
