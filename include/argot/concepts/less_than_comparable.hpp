...
#ifndef ARGOT_CONCEPTS_LESS_THAN_COMPARABLE_HPP_
#define ARGOT_CONCEPTS_LESS_THAN_COMPARABLE_HPP_

//[description
/*`
LessThanComparable is an [argot_gen_concept] that is satisfied by types `T`
...
template< class T >
ARGOT_EXPLICIT_CONCEPT( LessThanComparable )
(
  Object< T >
);
...
#endif  // ARGOT_CONCEPTS_LESS_THAN_COMPARABLE_HPP_
