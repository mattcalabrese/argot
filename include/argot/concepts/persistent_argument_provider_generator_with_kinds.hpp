...
namespace argot {
namespace persistent_argument_provider_generator_with_kinds_detail {
...
>
{
  ...
  using expand_requirements
    = Req< PersistentArgumentProviderGeneratorWithEach< Invocable, Kinds... > >;
};

} // namespace argot(::persistent_argument_provider_generator_with_kinds_detail)

#define ARGOT_DETAIL_PREPROCESSED_CONCEPT_HEADER_NAME()                        \
s/persistent_argument_provider_generator_with_kinds.h
...
ARGOT_AUTO_CONCEPT( PersistentArgumentProviderGeneratorWithKinds )
( ArgumentListKinds< ArgListKinds >
, TransparentRequirement
  < persistent_argument_provider_generator_with_kinds_detail
