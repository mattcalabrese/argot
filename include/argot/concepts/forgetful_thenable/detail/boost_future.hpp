...
#ifndef ARGOT_CONCEPTS_FORGETFUL_THENABLE_DETAIL_BOOST_FUTURE_HPP_
#define ARGOT_CONCEPTS_FORGETFUL_THENABLE_DETAIL_BOOST_FUTURE_HPP_
...
intrinsic_then( boost::future< T >&& self, Fun&& fun )
{
  ...
  ( boost::launch::sync
  , [ fun = ARGOT_MOVE( fun ) ]( boost::future< T >&& self_arg ) mutable
    {
...
< ForgetfulThenable< boost::future< T >, executor::immediate_t > >
{
  template< class Fun >
  static constexpr void
  forgetful_then( boost::future< T >&& self, executor::immediate_t, Fun&& fun )
  {
    (void)detail_future_boost_future::intrinsic_then
...
#endif  // ARGOT_CONCEPTS_FORGETFUL_THENABLE_DETAIL_BOOST_FUTURE_HPP_
