...
#ifndef ARGOT_CONCEPTS_CONCURRENT_ARGUMENT_PROVIDER_TO_HPP_
#define ARGOT_CONCEPTS_CONCURRENT_ARGUMENT_PROVIDER_TO_HPP_
...
namespace argot {
namespace detail_concurrent_argument_provider_to {
  ...
  using expand_requirements
    = Reqs
      < ArgumentReceiverOfKinds
        < Receiver
        , conc_traits::argument_list_kinds_of_destructive_t< Provider >
        >
      >;
};

}  // namespace argot(::detail_concurrent_argument_provider_to)

#define ARGOT_DETAIL_PREPROCESSED_CONCEPT_HEADER_NAME()                        \
s/concurrent_argument_provider_to.h
...
template< class Provider, class Receiver >
ARGOT_AUTO_CONCEPT( ConcurrentArgumentProviderTo )
...
, TransparentRequirement
  < detail_concurrent_argument_provider_to
...
#endif  // ARGOT_CONCEPTS_CONCURRENT_ARGUMENT_PROVIDER_TO_HPP_
