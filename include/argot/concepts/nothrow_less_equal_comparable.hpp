...
#ifndef ARGOT_CONCEPTS_NOTHROW_LESS_EQUAL_COMPARABLE_HPP_
...
s/nothrow_less_equal_comparable.h
...
template< class T >
ARGOT_EXPLICIT_CONCEPT( NothrowLessEqualComparable )
(
...
#endif  // ARGOT_CONCEPTS_NOTHROW_LESS_EQUAL_COMPARABLE_HPP_
