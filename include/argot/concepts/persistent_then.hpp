...
ARGOT_AUTO_CONCEPT( PersistentThenable )
(
  Then< Fut, FutSpawner >
);
...
#include <argot/concepts/persistent_then/persistent_then_boost_future.hpp>
#include <argot/concepts/persistent_then/persistent_then_boost_shared_future.hpp>
#endif

#ifdef ARGOT_HAS_STLAB_FUTURE
#include <argot/concepts/persistent_then/persistent_then_stlab_future.hpp>
#endif
