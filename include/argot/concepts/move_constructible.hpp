...
template< class T >
ARGOT_AUTO_CONCEPT( MoveConstructible )
( Destructible< T >
, True  // TODO(mattcalabrese) Lazily evaluate move constructible
  < std::is_move_constructible_v< T > >  // TODO(mattcalabrese) Define directly.
);
