...
#ifndef ARGOT_CONCEPTS_ARGUMENT_PROVIDER_GENERATOR_WITH_EACH_HPP_
#define ARGOT_CONCEPTS_ARGUMENT_PROVIDER_GENERATOR_WITH_EACH_HPP_
...
namespace argot {
namespace argument_provider_generator_with_each_detail {
...
template< class Invocable, class... ArgTypes >
ARGOT_AUTO_CONCEPT( ArgumentProviderGeneratorWithEach )
( ArgumentTypes< ArgTypes >...
, TransparentRequirement
  < argument_provider_generator_with_each_detail
