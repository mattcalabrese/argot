...
#ifndef ARGOT_CONCEPTS_COMPOSABLE_WITH_PERSISTENT_PROVISION_HPP_
#define ARGOT_CONCEPTS_COMPOSABLE_WITH_PERSISTENT_PROVISION_HPP_
...
namespace argot {
namespace composable_with_persistent_provision_detail {
...
}  // namespace argot(::composable_with_persistent_provision_detail)

#define ARGOT_DETAIL_PREPROCESSED_CONCEPT_HEADER_NAME()                        \
s/composable_with_persistent_provision.h
...
template< class Provider, class... Transformations >
ARGOT_AUTO_CONCEPT( ComposableWithPersistentProvision )
(
  PersistentArgumentProvider< Provider >
, ComposableWithProvision< Provider, Transformations... >  // TODO(mattcalabrese) Possibly remove
, TransparentRequirement
  < composable_with_persistent_provision_detail
...
#endif  // ARGOT_CONCEPTS_COMPOSABLE_WITH_PERSISTENT_PROVISION_HPP_
