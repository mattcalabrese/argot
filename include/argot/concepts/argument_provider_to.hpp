...
#ifndef ARGOT_CONCEPTS_ARGUMENT_PROVIDER_TO_HPP_
#define ARGOT_CONCEPTS_ARGUMENT_PROVIDER_TO_HPP_
...
namespace argot {
namespace argument_provider_to_detail {
...
} // namespace argot(::argument_provider_to_detail)

#define ARGOT_DETAIL_PREPROCESSED_CONCEPT_HEADER_NAME()                        \
s/argument_provider_to.h
...
template< class Provider, class Receiver >
ARGOT_AUTO_CONCEPT( ArgumentProviderTo )
( ArgumentProvider< Provider >
// TODO(mattcalabrese) First check that the provider can provide at all.
, TransparentRequirement
  < argument_provider_to_detail::argument_receiver_of< Provider, Receiver > >
);
...
#endif  // ARGOT_CONCEPTS_ARGUMENT_PROVIDER_TO_HPP_
