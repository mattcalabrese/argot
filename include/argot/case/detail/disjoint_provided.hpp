...
#ifndef ARGOT_CASE_DETAIL_DISJOINT_PROVIDED_HPP_
#define ARGOT_CASE_DETAIL_DISJOINT_PROVIDED_HPP_
...
< SwitchBody< case_detail::disjoint_provided_t< Cases, Provider > > >
{
...
struct make_concept_map
< SwitchBodyCase< case_detail::disjoint_provided_t< Cases, Provider >, Value >
, ARGOT_REQUIRES
  ( True
...
>
{
  ...
  ( argot::case_detail::disjoint_provided_t< Cases, Provider >&& self
  , Receiver&& rec
  )
  {
...
< PersistentSwitchBodyCase
  < case_detail::disjoint_provided_t< Cases, Provider >, Value >
>
{
  using leading_argument_list_kinds_t
    = receiver_traits::argument_list_kinds_t<>;
  ...
  template< class Receiver >
  static constexpr decltype( auto ) provide_isolated_case
  ( argot::case_detail::disjoint_provided_t< Cases, Provider > const& self
  , Receiver&& rec
  )
  {
