...
#ifndef ARGOT_GEN_CONCEPT_BODY_DETAIL_UNPARSE_NODE_HPP_
#define ARGOT_GEN_CONCEPT_BODY_DETAIL_UNPARSE_NODE_HPP_
...
#define ARGOT_GEN_DETAIL_UNPARSE_NODE_0( node )                                \
ARGOT_GEN_DETAIL_VISIT_NODE( node, ARGOT_GEN_DETAIL_UNPARSE_NODE_IMPL_0, ~ )
...
#define ARGOT_GEN_DETAIL_UNPARSE_NODE_IMPL_0( v, is_comp, kind, contents, d )  \
BOOST_PP_IIF( is_comp                                                          \
            , ARGOT_GEN_DETAIL_UNPARSE_NODE_COMPOSITE_0                        \
...
#define ARGOT_GEN_DETAIL_UNPARSE_NODE_COMPOSITE_0( kind, contents )            \
BOOST_PP_FOR( BOOST_PP_TUPLE_PUSH_BACK( contents, ~ )                          \
            ...
            , ARGOT_GEN_DETAIL_UNPARSE_NODE_COMPOSITE_BODY_0                   \
            )
...
#define ARGOT_GEN_DETAIL_UNPARSE_NODE_COMPOSITE_BODY_0( r, contents )          \
...
#endif  // ARGOT_GEN_CONCEPT_BODY_DETAIL_UNPARSE_NODE_HPP_
