...
#ifndef ARGOT_SWITCH_TRAITS_TRAILING_ARGUMENT_LIST_KINDS_OF_CASE_PERSISTENT_HPP_
#define ARGOT_SWITCH_TRAITS_TRAILING_ARGUMENT_LIST_KINDS_OF_CASE_PERSISTENT_HPP_
...
using trailing_argument_list_kinds_of_case_persistent_t
...
template< class Case >
using trailing_argument_list_kinds_of_case_persistent
  = call_detail::lazy_expand
    < trailing_argument_list_kinds_of_case_persistent_t, Case >;
*/
