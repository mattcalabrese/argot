...
#ifndef ARGOT_SWITCH_TRAITS_ARGUMENT_LIST_KINDS_OF_BODY_DESTRUCTIVE_HPP_
#define ARGOT_SWITCH_TRAITS_ARGUMENT_LIST_KINDS_OF_BODY_DESTRUCTIVE_HPP_
...
namespace argument_list_kinds_of_body_destructive_detail {
...
struct default_based_impl
{
  using type
    = call_detail::concatenate_t
      < leading_argument_list_kinds_of_default_destructive_t< Body, ValueType >
      , argument_list_kinds_of_default_destructive_t< Body, ValueType >
      , trailing_argument_list_kinds_of_default_destructive_t< Body, ValueType >
      >;
};
...
struct case_based_impl
{
  using type
    = call_detail::concatenate_t
      < leading_argument_list_kinds_of_case_destructive_t
        < Body, case_value_for_type_at_v< Body, ValueType, 0 > >
      , argument_list_kinds_of_case_destructive_t
        < Body, case_value_for_type_at_v< Body, ValueType, 0 > >
      , trailing_argument_list_kinds_of_case_destructive_t
        < Body, case_value_for_type_at_v< Body, ValueType, 0 > >
      >;
};
...
struct no_cases_impl
{
  using type
    = typename argot_detail::conditional
      < is_modeled_v< SwitchBodyDefaultForType< Body, ValueType > > >
      ::template apply
...
template< class Body, class ValueType >
using argument_list_kinds_of_body_destructive
