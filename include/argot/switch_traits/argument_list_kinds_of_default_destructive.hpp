...
#ifndef ARGOT_SWITCH_TRAITS_ARGUMENT_LIST_KINDS_OF_DESTRUCTIVE_HPP_
#define ARGOT_SWITCH_TRAITS_ARGUMENT_LIST_KINDS_OF_DESTRUCTIVE_HPP_
...
namespace argument_list_kinds_of_default_destructive_detail {
...
using explicit_argument_list_kinds_of_t
  = typename access_raw_concept_map
    ...
    ::argument_list_kinds_of_default_destructive_t;
...
struct deduce_argument_list_kinds_of
{
 private:
  using detected_result_type
    = decltype
      ( access_raw_concept_map< SwitchBodyDefaultForType< Body, ValueType > >
 ...
 public:
  using type
   ...
   // argot::switch_traits(::argument_list_kinds_of_default_destructive_detail)

template< class Body, class ValueType >
using argument_list_kinds_of_default_destructive_t
  = ARGOT_REQUIRES( SwitchBodyDefaultForType< Body, ValueType > )
    < typename argot_detail::conditional
      < call_detail::is_detected_v
        < argument_list_kinds_of_default_destructive_detail
...
template< class Body >
using argument_list_kinds_of_default_destructive
  = call_detail::lazy_expand
    < argument_list_kinds_of_default_destructive_t, Body >;

// TODO(mattcalabrese) Pass ValueType
template< class Body, class ValueType >
argument_list_kinds_of_default_destructive_t< Body, ValueType > constexpr
argument_list_kinds_of_default_destructive_v{};

}  // namespace argot(::switch_traits)

}  // namespace argot

#endif  // ARGOT_SWITCH_TRAITS_ARGUMENT_LIST_KINDS_OF_DESTRUCTIVE_HPP_
