...
#ifndef ARGOT_SWITCH_TRAITS_LEADING_ARGUMENT_LIST_KINDS_OF_DEFAULT_PERSISTENT_HPP_
#define ARGOT_SWITCH_TRAITS_LEADING_ARGUMENT_LIST_KINDS_OF_DEFAULT_PERSISTENT_HPP_
...
using leading_argument_list_kinds_of_default_persistent_t
...
template< class Def, class ValueType >
using leading_argument_list_kinds_of_default_persistent
