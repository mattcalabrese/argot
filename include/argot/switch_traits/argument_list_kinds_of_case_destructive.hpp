...
#ifndef ARGOT_SWITCH_TRAITS_ARGUMENT_LIST_KINDS_OF_CASE_DESTRUCTIVE_HPP_
#define ARGOT_SWITCH_TRAITS_ARGUMENT_LIST_KINDS_OF_CASE_DESTRUCTIVE_HPP_
...
namespace argument_list_kinds_of_case_destructive_detail {
...
struct explicit_argument_list_kinds_of_case_destructive_is_detected
  : std::false_type {};
...
struct deduce_argument_list_kinds_of
{
 private:
  using detected_result_type
    = decltype
      ( access_raw_concept_map< SwitchBodyCase< Case, Value > >
...
template< class Case, auto Value >
using argument_list_kinds_of_case_destructive_t
  = ARGOT_REQUIRES( SwitchBodyCase< Case, Value > )
    < typename argot_detail::conditional
      < argument_list_kinds_of_case_destructive_detail
        ::explicit_argument_list_kinds_of_case_destructive_is_detected
        < Case, Value >::value
      >::template apply
      < argument_list_kinds_of_case_destructive_detail
...
template< class Case >
using argument_list_kinds_of_case_destructive
  = call_detail::lazy_expand< argument_list_kinds_of_case_destructive_t, Case >;
*/
