...
using prov::bind_call;
using prov::reference_to;
using prov::value_of;
using prov::result_of_conditional_t;
using prov::result_of_bind_call;
using prov::result_of_bind_call_t;
...
ARGOT_REGISTER_CONSTEXPR_TEST( test_bind_call_nullary )
{
  decltype( auto ) provider
    = bind_call( tracked_forward_arguments_as_tuple );
  ...
  // rvalue provision
  {
    ...
    ( SameType
      ...
      , discriminated_union
        < std::tuple< lvalue_call_t const& >
        , std::tuple< rvalue_call_t const& >
        >
      >
    );
...
ARGOT_REGISTER_CONSTEXPR_TEST( test_nonbranching_unary_bind_call )
{
  foo foo_a = foo::a;
...
ARGOT_REGISTER_CONSTEXPR_TEST( test_nonbranching_bind_call )
{
  foo                foo_a = foo::a;
...
ARGOT_REGISTER_CONSTEXPR_TEST( test_branching_unary_bind_call )
{
  foo foo_a = foo::a;
  bar bar_b = bar::b;
...
ARGOT_REGISTER_CONSTEXPR_TEST( test_branching_ternary_bind_call )
{
  foo1 foo1_a = foo1::a;
  bar1 bar1_b = bar1::b;
  ...
  // rvalue provision
  {
    ...
    // branch4
    {
      ...
      auto& tup = variant_traits::get< 9 >( provision_result );
    ...
    // branch5
    {
      ...
      auto& tup = variant_traits::get< 11 >( provision_result );
    ...
    // branch6
    {
      ...
      auto& tup = variant_traits::get< 13 >( provision_result );
    ...
    // branch7
    {
      ...
      auto& tup = variant_traits::get< 15 >( provision_result );
  ...
  // lvalue provision
  {
    ...
    // branch4
    {
      ...
      auto& tup = variant_traits::get< 8 >( provision_result );
    ...
    // branch5
    {
      ...
      auto& tup = variant_traits::get< 10 >( provision_result );
    ...
    // branch6
    {
      ...
      auto& tup = variant_traits::get< 12 >( provision_result );
    ...
    // branch7
    {
      ...
      auto& tup = variant_traits::get< 14 >( provision_result );
