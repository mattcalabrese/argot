...
using argot::copyable_opaque_optional;
...
template< class T >
constexpr std::remove_reference_t< T > const&
const_lvalue( T&& arg )
{
  return arg;
}
...
using force_instantiation [[maybe_unused]]
  = std::integral_constant
    < std::size_t
    , sizeof( copyable_opaque_optional< delayed_complete_type > )
    >;
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_complete )
{
  using opt = copyable_opaque_optional< int >;
  ...
  using prof
    = argot_test::combine_regularity_profiles_t
      ...
      , argot_test::exceptional_copy_constructor_profile
      , argot_test::nothrow_move_assign_profile
      , argot_test::exceptional_copy_assign_profile
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_default_constructor )
{
  copyable_opaque_optional< int > const empty;
...
ARGOT_REGISTER_TEST
( test_copyable_opaque_optional_in_place_constructor_no_ilist )
{
  {
    copyable_opaque_optional< int > const obj( std::in_place );
    ARGOT_TEST_TRUE( obj.has_value() );
    ARGOT_TEST_EQ( *obj, 0 );
  }

  {
    copyable_opaque_optional< int > const obj( std::in_place, 5 );
    ARGOT_TEST_TRUE( obj.has_value() );
    ARGOT_TEST_EQ( *obj, 5 );
  }
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_in_place_constructor_ilist )
{
  copyable_opaque_optional< array4_and_int > const obj
...
ARGOT_REGISTER_TEST
( test_copyable_opaque_optional_in_place_with_result_constructor )
{
  copyable_opaque_optional< int > const
...
ARGOT_REGISTER_TEST
( test_copyable_opaque_optional_in_place_default_init_constructor )
{
  copyable_opaque_optional< int > const obj( argot::in_place_default_init );
  ARGOT_TEST_TRUE( obj.has_value() );

  return 0;
}

ARGOT_REGISTER_TEST( test_copyable_opaque_optional_dereference )
{
  {
    copyable_opaque_optional< int > obj( std::in_place, 5 );
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_arrow )
{
  {
    copyable_opaque_optional< int > obj( std::in_place, 5 );
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_member_swap )
{
  struct immovable
  {
  ...
  {
    copyable_opaque_optional< immovable > lhs;
    copyable_opaque_optional< immovable > rhs;
  ...
  {
    copyable_opaque_optional< immovable > lhs( std::in_place, 5 );
    copyable_opaque_optional< immovable > rhs;
  ...
  {
    copyable_opaque_optional< immovable > lhs;
    copyable_opaque_optional< immovable > rhs( std::in_place, 5 );
  ...
  {
    copyable_opaque_optional< immovable > lhs( std::in_place, 5 );
    copyable_opaque_optional< immovable > rhs( std::in_place, 10 );
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_delayed_completeness )
{
  using opt = copyable_opaque_optional< delayed_complete_type >;
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_has_value )
{
  copyable_opaque_optional< int > const empty;
  copyable_opaque_optional< int > const not_empty( std::in_place );
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_reset )
{
  copyable_opaque_optional< int > initially_not_empty( std::in_place );
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_emplace_no_ilist )
{
  {
    copyable_opaque_optional< move_only_no_assign >
    ...
    ARGOT_TEST_EQ
    ( initially_not_empty
    , copyable_opaque_optional< move_only_no_assign >( std::in_place, 5 )
    );
  }
  ...
  {
    copyable_opaque_optional< move_only_no_assign > initially_empty;
  ...
  {
    copyable_opaque_optional< copyable_no_assign >
      initially_not_empty( std::in_place, 0 );
    ...
    ARGOT_TEST_EQ
    ( initially_not_empty
    , copyable_opaque_optional< copyable_no_assign >( std::in_place, 5 )
    );
  }

  {
    copyable_opaque_optional< copyable_no_assign > initially_empty;
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_emplace_ilist )
{
  {
    copyable_opaque_optional< array4_and_int >
  ...
  {
    copyable_opaque_optional< array4_and_int > initially_empty;
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_emplace_with_result )
{
  {
    copyable_opaque_optional< int >
      initially_not_empty( std::in_place, 0 );
    ...
    ARGOT_TEST_EQ
    ( initially_not_empty
    , copyable_opaque_optional< int >( std::in_place, 5 )
    );
  }

  {
    copyable_opaque_optional< int > initially_empty;
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_emplace_default_init )
{
  {
    copyable_opaque_optional< int >
      initially_not_empty( std::in_place, 0 );
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_assign_rvalue )
{
  {
    copyable_opaque_optional< int >
      initially_not_empty( std::in_place, 0 );
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_assign_lvalue )
{
  {
    copyable_opaque_optional< int >
      initially_not_empty( std::in_place, 0 );
...
ARGOT_REGISTER_TEST( test_make_copyable_opaque_optional_in_place_default_init )
{
  decltype( auto ) obj
    = argot::make_copyable_opaque_optional_default_init< int >();
...
ARGOT_REGISTER_TEST( test_make_copyable_opaque_optional_deduced )
{
  {
    decltype( auto ) obj = argot::make_copyable_opaque_optional( 5 );
    ARGOT_CONCEPT_ENSURE
    ( argot::SameType< decltype( obj )
                     , copyable_opaque_optional< int >
                     >
...

  {
    ...
    decltype( auto ) obj = argot::make_copyable_opaque_optional( array );
    ARGOT_CONCEPT_ENSURE
    ( argot::SameType< decltype( obj )
                     , copyable_opaque_optional< int const* >
                     >
  ...
  {
    decltype( auto ) obj
      = argot::make_copyable_opaque_optional( function_to_decay );
    ARGOT_CONCEPT_ENSURE
    ( argot::SameType< decltype( obj )
                     , copyable_opaque_optional< void (*)() >
                     >
    );
...

  {
    ...
    decltype( auto ) obj
      = argot::make_copyable_opaque_optional( move_only( 5 ) );
    ARGOT_CONCEPT_ENSURE
    ( argot::SameType< decltype( obj )
                     , copyable_opaque_optional< move_only >
                     >
    );
...
ARGOT_REGISTER_TEST( test_make_copyable_opaque_optional_no_ilist )
{
  {
    decltype( auto ) obj = argot::make_copyable_opaque_optional< int >();
    ARGOT_CONCEPT_ENSURE
    ( argot::SameType< decltype( obj )
                     , copyable_opaque_optional< int >
                     >
  ...
  {
    decltype( auto ) obj = argot::make_copyable_opaque_optional< int >( 5 );
    ARGOT_CONCEPT_ENSURE
    ( argot::SameType< decltype( obj )
                     , copyable_opaque_optional< int >
                     >
...
ARGOT_REGISTER_TEST( test_make_copyable_opaque_optional_ilist )
{
  decltype( auto ) obj
    = argot::make_copyable_opaque_optional< array4_and_int >
      ( { 1, 2, 3, 4 }, 5 );
  ARGOT_CONCEPT_ENSURE
  ( argot::SameType< decltype( obj )
                   , copyable_opaque_optional< array4_and_int >
...
ARGOT_REGISTER_TEST( test_make_copyable_opaque_optional_with_result )
{
  {
    decltype( auto ) obj
      = argot::make_copyable_opaque_optional_with_result( []{ return 5; } );
    ARGOT_CONCEPT_ENSURE
    ( argot::SameType< decltype( obj )
                     , copyable_opaque_optional< int >
                     >
  ...
  {
    decltype( auto ) obj
      = argot::make_copyable_opaque_optional_with_result< int >
        ( []{ return 5; } );
    ARGOT_CONCEPT_ENSURE
    ( argot::SameType< decltype( obj )
                     , copyable_opaque_optional< int >
...
ARGOT_REGISTER_TEST( test_copyable_opaque_optional_optional_like )
{
  ARGOT_TEST_TRUE
  ( ARGOT_IS_MODELED
    ( argot::OptionalLike< copyable_opaque_optional< int > > )
  );

  namespace opt_traits = argot::opt_traits;

  {
    copyable_opaque_optional< int > const obj;
