...
ARGOT_REGISTER_CONSTEXPR_TEST( test_access_unary )
{
  ...
  auto provider_lvalue = +var;
  auto provider_const_lvalue = +const_var;
  auto provider_rvalue = +std::move( var );
...
ARGOT_REGISTER_CONSTEXPR_TEST( test_access_ternary )
{
  ...
  auto provider_a_lvalue = +var_a;
  auto provider_a_const_lvalue = +const_var_a;
  auto provider_a_rvalue = +std::move( var_a );
  auto provider_b_lvalue = +var_b;
  auto provider_b_const_lvalue = +const_var_b;
  auto provider_b_rvalue = +std::move( var_b );
  auto provider_c_lvalue = +var_c;
  auto provider_c_const_lvalue = +const_var_c;
  auto provider_c_rvalue = +std::move( var_c );
