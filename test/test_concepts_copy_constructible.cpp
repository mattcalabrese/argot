...
ARGOT_CONCEPT_ENSURE( CopyConstructible< trivial_copy_constructor > );
ARGOT_CONCEPT_ENSURE( CopyConstructible< nothrow_copy_constructor > );
ARGOT_CONCEPT_ENSURE( CopyConstructible< throwing_copy_constructor > );

ARGOT_CONCEPT_ENSURE( Not< CopyConstructible< no_copy_constructor > > );
